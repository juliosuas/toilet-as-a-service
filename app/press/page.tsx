...
export default function PressPage() {
  ...
  return <main className="press-page shell"><a className="back-link" href="/">← Back to TaaS</a><header><span>PRESS ROOM · INTERACTIVE SATIRE</span><h1>Toilet as<br />a Service.</h1><p>An interactive satire about infrastructure, privacy, and the attention economy, created in Mexico City.</p></header><section><h2>In one line</h2><p className="press-lede">A startup turns human urgency into measurable ad inventory.</p></section><section><h2>About</h2><p>TaaS imagines a network of urban restrooms funded by impossible-to-ignore ads. The interface, metrics, and plans are part of a fictional demonstration; no units, memberships, or real-world operations exist.</p></section><section><h2>Assets</h2><div className="asset-grid"><article className="asset-card"><img src="/og.png" width="1200" height="630" alt="Toilet as a Service social card" /><span>LAUNCH CARD · 1200 × 630</span><a href="/og.png" download>Download PNG ↓</a></article><article className="asset-card"><img src="/access-exchange-loop.svg" width="1440" height="900" alt="Animated sponsored access countdown" /><span>MOTION LOOP · RESPONSIVE SVG</span><a href="/access-exchange-loop.svg" download>Download animated SVG ↓</a></article><article className="asset-card"><img src="/taas-access-moment.webp" width="1280" height="719" alt="Hand approaching the twelve-second door interface" /><span>ACCESS MOMENT · HIGGSFIELD</span><a href="/taas-access-moment.webp" download>Download WebP ↓</a></article></div></section><section><h2>Ready-to-post copy</h2><div className="copy-grid">{posts.map((post) => <article key={post}><p>{post}</p><button onClick={() => copy(post)}>Copy text</button></article>)}</div></section><footer><b>Disclosure</b><p>Independent conceptual project. It collects no personal data, processes no payments, and does not represent a real sanitation service.</p></footer></main>;
}
